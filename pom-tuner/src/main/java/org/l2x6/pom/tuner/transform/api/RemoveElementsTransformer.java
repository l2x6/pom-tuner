 ...
 * @since  5.0.0
 */
public class RemoveElementsTransformer<T extends TextElement> implements Transformer {
     ...
     * @see                    ProfileId
     */
    public RemoveElementsTransformer<T> profiles(Predicate<String> profileSelector) {
     ...
     */
    public RemoveElementsTransformer<T> profiles(String... profileIds) {
        return new RemoveElementsTransformer<>(
     ...
     */
    public RemoveElementsTransformer<T> profilesOnly(String... profileIds) {
        return new RemoveElementsTransformer<>(
     ...
     * @see                     Siblings
     */
    public RemoveElementsTransformer<T> alsoRemove(Function<Node, List<Node>> siblingsSelector) {
        return new RemoveElementsTransformer<>(
                profileSelector,
                profileToRemovedElements,
                elementSelector,
     ...
     */
    public RemoveElementsTransformer<T> alsoRemovePrevious(Predicate<Node> nodeSelector) {
        return new RemoveElementsTransformer<>(
                profileSelector,
                profileToRemovedElements,
                elementSelector,
     ...
     */
    public RemoveElementsTransformer<T> alsoRemoveNext(Predicate<Node> nodeSelector) {
        return new RemoveElementsTransformer<>(
                profileSelector,
                profileToRemovedElements,
                elementSelector,
     ...
     * @see    Siblings
     */
    public RemoveElementsTransformer<T> alsoRemoveNone() {
        return new RemoveElementsTransformer<>(
                profileSelector,
                profileToRemovedElements,
                elementSelector,
